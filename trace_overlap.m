% Here we use startTime to know when to start the plot along the x axis
% against the LFP data.  

function trace_overlap (ms,cellNum, LFP_timestamp, startTime, trace)
traceNum = cellNum; 
